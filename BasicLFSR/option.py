...
parser.add_argument("--scale", type=int, default=2, help="4, 2")

parser.add_argument('--model_name', type=str, default='DSMNet', help="model name")
...
parser.add_argument('--resume_epoch', type=int, default=1, help='num workers of the Data Loader')
